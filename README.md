...
## Documentation
This App creates a Shiny UI that allows the interactive visualization of location data in map, graphical, and tabular form. The App is meant to work in conjunction in a workflow with the Collar-Health-Alert-App (and possibly filtered by Collar-Health-Filter-App) and used the move2 dataset with fields appended for each alert type: mortality, cluster, nsd, voltage, gps_accuracy, gps_transmission, and gps_resurrection. 
